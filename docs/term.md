...
# 利用規約
本利用規約（以下、本規約）は、やみすきー運営陣（以下、管理者）が本ウェブサイト上に提供するサービス（本サービス）の利用要件を定めるものです。登録者の皆様（以下、ユーザー）には、利用にあたり本規約に同意していただく必要がございます。
...
7. 使い捨てのメールアドレスでアカウントを作成していると判断される場合
...
11. 以下を目的とし、または目的とすると管理者が判断する行為
    ...
    - 三.　面識のない相手との出会いや交際を目的とし、マッチングを意図してする行為
...
12. ユーザーによる自治行為（異議申し立てなどは通報、あるいはメール、公式Matrixサーバー等で行ってください。）
13. 12歳未満による本規約が適用された後の新規登録
14. 招待制の場合の、不適切ユーザーに対する招待
15. 承認制の場合の、虚偽や曖昧な登録理由の申請
16. 責任能力がないユーザーが、個人情報をサーバーに送信する行為
17. 自殺・自傷行為を推奨する行為
18. 違法薬物の取引を推奨する行為
19. サーバーに許可なく負荷をかける行為
20. サーバーの脆弱性を許可なく探す行為
21. サーバーに許可なく侵入する行為
22. その他管理者が不適切であると客観的に判断しうる行為
